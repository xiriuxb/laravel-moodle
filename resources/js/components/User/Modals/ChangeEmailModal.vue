          ...
          <div class="modal-wrapper">
            <div class="modal-container">
              ...
              <div class="modal-body">
                <slot name="body">
                  <div class="alert alert-danger" role="alert" v-if="errors.new_email">
                        {{ errors.new_email[0] }}
                  </div>
              ...
              <div class="modal-footer">
                <slot name="footer">
                  <button class="btn btn-primary" @click.prevent="changeEmail()" :disabled="loading || form.new_email.length==0">
...
export default {
    methods: {
        async changeEmail(){
          this.loading = true;
          this.errors=[];
            await axios.post('/change-email', this.form).then(response => {
                this.$emit('close');
                this.$toast.open({
