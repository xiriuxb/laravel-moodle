...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="passwordModalCenter" tabindex="-1" aria-labelledby="passwordModalCenterTitle" aria-modal="true" role="dialog">
